# [Gold III] 단순 사각형 - 2648 

[문제 링크](https://www.acmicpc.net/problem/2648) 

### 성능 요약

메모리: 20644 KB, 시간: 184 ms
...
2025년 11월 2일 19:49:31

### 문제 설명

<p>평면상에서 어떤 로봇이 수평 또는 수직으로 선을 그으면서 움직인다. 이 로봇은 처음 정해진 위치에서 시작하여 움직인 뒤 다시 처음 위치로 되돌아 온다.</p>
